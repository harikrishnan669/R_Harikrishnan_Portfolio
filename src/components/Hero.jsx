...
export default function Hero() {
  const socialLinks = [
    { name: 'WhatsApp', href: 'https://wa.me/9656990468', icon: 'fa-whatsapp' },
    { name: 'LinkedIn', href: 'https://www.linkedin.com/in/hari2k4/', icon: 'fa-linkedin' },
    { name: 'GitHub', href: 'https://github.com/harikrishnan669', icon: 'fa-github' },
    { name: 'X / Twitter', href: 'https://x.com/hari_2k4', icon: 'fa-x-twitter' },
    { name: 'Instagram', href: 'https://www.instagram.com/hari_2k4/', icon: 'fa-instagram' },
    { name: 'Behance', href: 'https://www.behance.net/11er', icon: 'fa-behance' },
  ];
          ...
          <div className="lg:col-span-4 flex justify-center lg:justify-start">
            <div className="relative group">
              <div className="w-56 h-56 sm:w-64 sm:h-64 rounded-3xl p-1.5 bg-gradient-to-b from-white/30 via-white/10 to-transparent border border-white/20 shadow-2xl">
                <img
                  src="https://avatars.githubusercontent.com/u/128880349?v=4"
                  alt="R Harikrishnan"
          ...
          <div className="lg:col-span-8 flex flex-col gap-6 text-left">
            ...
            <div className="inline-flex items-center gap-2 self-start px-3.5 py-1.5 rounded-full bg-[#121215] border border-white/15">
              ...
              <span className="text-xs font-mono font-medium text-zinc-300">
                B.Tech Computer Science & Engineering • RIT Kottayam
              </span>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              {socialLinks.map((s) => (
                <a
                  ...
                  className="w-10 h-10 rounded-xl bg-[#141416] border border-white/10 hover:border-white text-zinc-400 hover:text-white flex items-center justify-center transition-all"
                  title={s.name}
                >
